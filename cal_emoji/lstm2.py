...
X_train=X[0:1611].reshape(1611,1,len(X[0]))
X_test=X[1611:1989].reshape(378,1,len(X[0]))
...
model.add(LSTM(128,input_shape=(1,len(X[0])),dropout=0.2,recurrent_dropout=0.2))#
